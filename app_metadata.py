...
UPDATE_RELEASE_ASSET_NAME = "AnnualReportSpider-Webview-Setup.exe"
UPDATE_SOURCE_URLS = (
...
def build_release_download_url(version: str) -> str:
    return f"{GITHUB_URL}/releases/download/{version}/{UPDATE_RELEASE_ASSET_NAME}"
